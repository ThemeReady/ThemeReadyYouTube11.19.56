...
.method public static a(ILandroid/app/Activity;ILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p0, p1, v0, v1, p3}, Lgtu;->b(ILandroid/app/Activity;Lfj;ILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public static a(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;Ljava/lang/String;Landroid/app/Dialog;)V
    ...
    iput-object v0, v2, Lgtx;->X:Landroid/app/Dialog;

    if-eqz p1, :cond_0

    iput-object p1, v2, Lgtx;->Y:Landroid/content/DialogInterface$OnCancelListener;

    .line 0
    :cond_0
    invoke-virtual {v2, v1, p2}, Lgtx;->a(Lfv;Ljava/lang/String;)V
    ...
    iput-object v0, v2, Lgtp;->a:Landroid/app/Dialog;

    if-eqz p1, :cond_2

    iput-object p1, v2, Lgtp;->b:Landroid/content/DialogInterface$OnCancelListener;

    .line 0
    :cond_2
    invoke-virtual {v2, v1, p2}, Lgtp;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method public static a(ILandroid/app/Activity;)Z
    ...
    invoke-static {p0, p1, v1, v0, v1}, Lgtu;->a(ILandroid/app/Activity;Lfj;ILandroid/content/DialogInterface$OnCancelListener;)Z
...
.method public static a(ILandroid/app/Activity;Lfj;ILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 2

    invoke-static {p0, p1, p2, p3, p4}, Lgtu;->b(ILandroid/app/Activity;Lfj;ILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, p4, v1, v0}, Lgtu;->a(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;Ljava/lang/String;Landroid/app/Dialog;)V
...
.method private static b(ILandroid/app/Activity;Lfj;ILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 9
    ...
    :cond_0
    invoke-static {p1}, Lgzj;->a(Landroid/content/Context;)Z
    ...
    :cond_3
    invoke-static {p1}, Lgtu;->g(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 8000
    :cond_4
    sget-object v1, Lgtq;->a:Lgtq;

    .line 0
    const-string v2, "d"

    invoke-virtual {v1, p1, p0, v2}, Lgtq;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v1, p1, v2, p3}, Lgxl;-><init>(Landroid/app/Activity;Landroid/content/Intent;I)V
    ...
    invoke-direct {v1, p2, v2, p3}, Lgxl;-><init>(Lfj;Landroid/content/Intent;I)V
