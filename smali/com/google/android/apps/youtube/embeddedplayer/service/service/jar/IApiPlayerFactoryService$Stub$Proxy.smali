...
# virtual methods
.method public final a(Lfpx;Lfqg;Lfqm;Lfqp;Lfpu;Lfpr;Lfqs;Lfqa;Lfqd;Lfqj;Lfqv;Z)Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IApiPlayerService;
    .locals 5
    ...
    invoke-interface {p1}, Lfpx;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p2}, Lfqg;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p3}, Lfqm;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p4}, Lfqp;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p5}, Lfpu;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p6}, Lfpr;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p7}, Lfqs;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p8}, Lfqa;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p9}, Lfqd;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p10}, Lfqj;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface/range {p11 .. p11}, Lfqv;->asBinder()Landroid/os/IBinder;
