...
.field private x:Lful;

.field private y:Lfvp;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lvhq;)V
    .locals 4
    ...
    invoke-direct {v0, p0}, Lvhn;-><init>(Lcom/google/android/moxie/common/player/VideoPlayer;)V
    ...
    invoke-direct {v0, p0}, Lvho;-><init>(Lcom/google/android/moxie/common/player/VideoPlayer;)V

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->x:Lful;
    ...
    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->y:Lfvp;

    .line 162
    iput-object p1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->e:Landroid/content/Context;

    .line 163
    iput-object p2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->b:Lvhq;
    ...
    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lfui;

    .line 165
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lfui;

    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->x:Lful;
    ...
    invoke-interface {v0, v3}, Lfui;->a(Z)V

    .line 167
    new-instance v0, Lghk;

    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lfui;

    invoke-direct {v0, v1}, Lghk;-><init>(Lfui;)V

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->j:Lghk;
...
.method public static create(Landroid/content/Context;Lvhq;)Lcom/google/android/moxie/common/player/VideoPlayer;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/android/moxie/common/player/VideoPlayer;-><init>(Landroid/content/Context;Lvhq;)V
...
.method public close()V
    ...
    .line 270
    iput-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lfwc;
...
.method public getPlayerControl()Lghk;
    .locals 1

    .prologue
    .line 386
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->j:Lghk;
...
.method public open(Ljava/lang/String;I)V
    ...
    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->r:Lvhm;
    ...
    iget-object v3, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->r:Lvhm;

    iget-object v6, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->y:Lfvp;

    invoke-static/range {v0 .. v6}, Lvhr;->a(Landroid/content/Context;Landroid/os/Handler;Ljava/lang/String;Lfur;Ljava/lang/String;ILfvp;)Lvhr;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lfwc;

    .line 2222
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lfwc;
    ...
    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lfwc;

    iget-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->m:Landroid/view/Surface;

    invoke-interface {v0, v1, v7, v2}, Lfui;->a(Lfuj;ILjava/lang/Object;)V

    .line 2226
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lfui;

    new-array v1, v7, [Lfwc;

    iget-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lfwc;
...
.method public pause()V
    ...
    .line 306
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->r:Lvhm;
...
.method public play(JJZ)V
    ...
    .line 287
    :cond_1
    iget-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lfui;

    invoke-interface {v2}, Lfui;->f()J
...
.method public update(J)Z
    ...
    .line 3048
    iput-wide v2, v0, Lvhm;->a:J

    .line 3049
    invoke-static {v2, v3}, Lvhm;->a(J)J

    move-result-wide v2

    iput-wide v2, v0, Lvhm;->b:J
