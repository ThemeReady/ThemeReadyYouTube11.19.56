...
# direct methods
.method static a(Landroid/app/Notification;Lhi;)V
    .locals 14
    ...
    .line 60
    iget-object v0, p1, Lhi;->a:Landroid/content/Context;

    iget-object v1, p1, Lhi;->b:Ljava/lang/CharSequence;

    iget-object v2, p1, Lhi;->c:Ljava/lang/CharSequence;

    iget-object v3, p1, Lhi;->f:Ljava/lang/CharSequence;

    iget-object v5, p1, Lhi;->e:Landroid/graphics/Bitmap;

    iget-object v6, p1, Lhi;->j:Ljava/lang/CharSequence;

    iget-object v7, p1, Lhi;->t:Landroid/app/Notification;

    iget-wide v8, v7, Landroid/app/Notification;->when:J

    iget-object v12, p1, Lhi;->p:Ljava/util/ArrayList;
    ...
    .line 2119
    invoke-static/range {v0 .. v11}, Labz;->a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIZ)Landroid/widget/RemoteViews;
    ...
    invoke-static {v0, v1}, Labz;->a(Landroid/content/Context;Lia;)Landroid/widget/RemoteViews;
...
.method static a(Lhb;Lhi;)V
    ...
    iget-object v8, p1, Lhi;->t:Landroid/app/Notification;

    iget-wide v8, v8, Landroid/app/Notification;->when:J

    iget-object v12, p1, Lhi;->p:Ljava/util/ArrayList;

    iget-object v13, v7, Laby;->a:[I
    ...
    .line 2054
    invoke-interface {p0}, Lhb;->a()Landroid/app/Notification$Builder;
...
.method static b(Lhb;Lhu;)V
    ...
    .line 37
    iget-object v1, p1, Laby;->a:[I

    iget-object v0, p1, Laby;->d:Lmn;
    ...
    .line 1813
    iget-object v0, v0, Lmn;->a:Ljava/lang/Object;
