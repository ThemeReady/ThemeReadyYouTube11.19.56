...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p0}, Lajx;-><init>(Landroid/support/v7/widget/ActivityChooserView;)V
    ...
    invoke-direct {v0, p0}, Lajy;-><init>(Landroid/support/v7/widget/ActivityChooserView;)V
    ...
    .line 1552
    invoke-direct {v0, p0}, Lakc;-><init>(Landroid/support/v7/widget/ActivityChooserView;)V

    .line 228
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Lakc;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Lams;

    .line 231
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Lams;

    invoke-virtual {v0}, Lams;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Lakc;
    ...
    invoke-direct {v2, p0, v0}, Lajz;-><init>(Landroid/support/v7/widget/ActivityChooserView;Landroid/view/View;)V
    ...
    .line 1637
    invoke-direct {v0, p0}, Lakb;-><init>(Landroid/support/v7/widget/ActivityChooserView;)V

    .line 263
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lakb;

    .line 264
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lakb;

    new-instance v1, Laka;

    invoke-direct {v1, p0}, Laka;-><init>(Landroid/support/v7/widget/ActivityChooserView;)V

    invoke-virtual {v0, v1}, Lakb;->registerDataSetObserver(Landroid/database/DataSetObserver;)V
...
.method public final a(I)V
    ...
    .line 355
    :goto_0
    iget-object v3, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lakb;

    .line 3798
    iget-object v3, v3, Lakb;->a:Lajs;
    ...
    invoke-virtual {v3, v1}, Lakb;->a(Z)V
    ...
    invoke-virtual {v3, v4}, Lakb;->a(I)V

    .line 366
    :goto_2
    invoke-virtual {p0}, Landroid/support/v7/widget/ActivityChooserView;->d()Lanc;

    move-result-object v3

    .line 4786
    iget-object v4, v3, Lanc;->e:Landroid/widget/PopupWindow;
    ...
    .line 369
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lakb;

    invoke-virtual {v2, v1, v0}, Lakb;->a(ZZ)V
    ...
    .line 374
    invoke-virtual {v3, v0}, Lanc;->a(I)V

    .line 375
    invoke-virtual {v3}, Lanc;->b()V

    .line 376
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->h:Lpz;
    ...
    invoke-virtual {v0, v1}, Lpz;->a(Z)V

    .line 4871
    :cond_2
    iget-object v0, v3, Lanc;->f:Lanf;
    ...
    invoke-virtual {v3, v2}, Lakb;->a(Z)V

    .line 363
    iget-object v3, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lakb;

    invoke-virtual {v3, p1}, Lakb;->a(I)V
    ...
    invoke-virtual {v0, v2, v2}, Lakb;->a(ZZ)V
...
.method public final a()Z
    ...
    .line 2786
    iget-object v1, v1, Lanc;->e:Landroid/widget/PopupWindow;
...
.method public final d()Lanc;
    .locals 2

    .prologue
    .line 503
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->p:Lanc;
    ...
    invoke-direct {v0, v1}, Lanc;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->p:Lanc;

    .line 505
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->p:Lanc;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lakb;
    ...
    .line 8445
    iput-object p0, v0, Lanc;->n:Landroid/view/View;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Lakc;

    .line 8564
    iput-object v1, v0, Lanc;->o:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    invoke-virtual {v0, v1}, Lanc;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method protected final onAttachedToWindow()V
    ...
    invoke-virtual {v0, v1}, Lajs;->registerObserver(Ljava/lang/Object;)V
...
.method protected final onDetachedFromWindow()V
    ...
    invoke-virtual {v0, v1}, Lajs;->unregisterObserver(Ljava/lang/Object;)V
...
.method protected final onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v3, v3, v1, v2}, Lams;->layout(IIII)V
