...
.field private mImageFrame:Larp;

.field private mImageType:Larz;
...
.method public constructor <init>(Last;Ljava/lang/String;)V
    ...
    .line 33
    iput-object v0, p0, Latp;->mLastBitmap:Landroid/graphics/Bitmap;

    .line 34
    iput-object v0, p0, Latp;->mImageType:Larz;

    .line 35
    iput-object v0, p0, Latp;->mImageFrame:Larp;

    .line 36
    const/4 v0, 0x0

    iput-boolean v0, p0, Latp;->mAlwaysRead:Z

    .line 37
    const-wide/16 v0, -0x1

    iput-wide v0, p0, Latp;->mTimestamp:J
...
.method public final getSignature()Lasy;
    ...
    invoke-virtual {v0, v1, v4, v2}, Lasy;->a(Ljava/lang/String;ILarz;)Lasy;
    ...
    iget-object v2, p0, Latp;->mImageType:Larz;
...
.method protected final onProcess()V
    ...
    invoke-virtual {p0, v0}, Latp;->getConnectedInputPort(Ljava/lang/String;)Lasq;
    ...
    invoke-virtual {p0, v1}, Latp;->getConnectedOutputPort(Ljava/lang/String;)Lasw;

    move-result-object v1

    .line 75
    iget-object v2, p0, Latp;->mLastBitmap:Landroid/graphics/Bitmap;

    if-ne v2, v0, :cond_0

    iget-boolean v2, p0, Latp;->mAlwaysRead:Z

    if-eqz v2, :cond_2

    .line 76
    :cond_0
    iget-object v2, p0, Latp;->mImageFrame:Larp;
    ...
    .line 80
    iget-object v3, p0, Latp;->mImageType:Larz;

    invoke-static {v3, v2}, Larm;->a(Larz;[I)Larm;
    ...
    iput-object v2, p0, Latp;->mImageFrame:Larp;

    .line 81
    iget-object v2, p0, Latp;->mImageFrame:Larp;

    invoke-virtual {v2, v0}, Larp;->a(Landroid/graphics/Bitmap;)V
    ...
    .line 85
    :cond_2
    iget-object v0, p0, Latp;->mImageFrame:Larp;
    ...
    .line 90
    :cond_3
    iget-wide v2, p0, Latp;->mTimestamp:J
    ...
    invoke-virtual {v0, v2, v3}, Larp;->a(J)V
