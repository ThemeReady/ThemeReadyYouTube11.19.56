...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgpm;->a:Ljava/lang/String;
    ...
    sput-object v0, Lgpm;->b:Landroid/content/ComponentName;
...
.method static a(Landroid/content/Context;Landroid/content/ComponentName;Lgpr;)Ljava/lang/Object;
    .locals 5
    ...
    invoke-static {p0}, Lgxy;->a(Landroid/content/Context;)Lgxy;

    move-result-object v2

    const-string v0, "GoogleAuthUtil"

    invoke-virtual {v2, p1, v1, v0}, Lgxy;->a(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {v1}, Lgzr;->a()Landroid/os/IBinder;

    move-result-object v0

    invoke-interface {p2, v0}, Lgpr;->a(Landroid/os/IBinder;)Ljava/lang/Object;
    :try_end_0
    ...
    invoke-virtual {v2, p1, v1, v3}, Lgxy;->b(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
...
.method static a(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lgtv;->d(Landroid/content/Context;)V
    :try_end_0
    ...
    invoke-direct {v1, v2, v3, v0}, Lgps;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-direct {v1, v0}, Lgpk;-><init>(Ljava/lang/String;)V
...
.method static c(Landroid/content/Context;Ljava/lang/String;)[Landroid/accounts/Account;
    ...
    .line 0
    invoke-static {p0}, Lgtr;->c(Landroid/content/Context;)V
