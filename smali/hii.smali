...
.method public final a(Lhmi;Ljava/util/Map;)V
    ...
    invoke-static {p1}, Lhig;->a(Lhmi;)Z
    ...
    .line 2000
    :cond_3
    invoke-static {p1}, Lhig;->b(Lhmi;)Lhie;
    ...
    .line 0
    :cond_5
    invoke-interface {p1}, Lhmi;->g()Lglk;

    move-result-object v1

    invoke-static {v1}, Lgwv;->a(Ljava/lang/Object;)V

    const/4 v1, 0x0

    invoke-interface {v1}, Lhij;->a()Lhih;

    move-result-object v1

    new-instance v2, Lhie;

    invoke-direct {v2, p1, v1, v0}, Lhie;-><init>(Lhmi;Lhih;Ljava/lang/String;)V
