...
.field private d:Lhzw;

.field private e:Lgzf;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1, v2}, Lhzt;-><init>(Landroid/content/Context;Lgzf;Ljava/lang/String;Ljava/util/concurrent/Executor;)V

    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Lgzf;Ljava/lang/String;Ljava/util/concurrent/Executor;)V
    .locals 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lhzt;->c:Landroid/content/Context;

    iput-object p2, p0, Lhzt;->e:Lgzf;

    const/16 v0, 0x7d0

    iput v0, p0, Lhzt;->f:I

    iput-object p4, p0, Lhzt;->b:Ljava/util/concurrent/Executor;

    new-instance v0, Lhzw;

    iget-object v1, p0, Lhzt;->c:Landroid/content/Context;

    invoke-direct {v0, p0, v1, p3}, Lhzw;-><init>(Lhzt;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lhzt;->d:Lhzw;
...
.method private final a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_0
    iget-object v0, p0, Lhzt;->d:Lhzw;

    invoke-virtual {v0}, Lhzw;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    ...
    invoke-static {p1}, Lhyd;->b(Ljava/lang/String;)V
...
.method private final a()Ljava/util/List;
    ...
    .line 0
    :try_start_0
    iget-object v0, p0, Lhzt;->e:Lgzf;

    invoke-interface {v0}, Lgzf;->a()J

    move-result-wide v0

    invoke-direct {p0, v0, v1}, Lhzt;->a(J)V

    invoke-direct {p0}, Lhzt;->b()Ljava/util/List;
    ...
    iget-object v4, v0, Lhzx;->a:Ljava/lang/String;

    iget-object v0, v0, Lhzx;->b:[B

    invoke-static {v0}, Lhzt;->a([B)Ljava/lang/Object;

    move-result-object v0

    invoke-direct {v3, v4, v0}, Lhxw;-><init>(Ljava/lang/String;Ljava/lang/Object;)V
...
.method private final a(I)Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lhzt;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method static synthetic a(Lhzt;)Ljava/util/List;
    .locals 1

    invoke-direct {p0}, Lhzt;->a()Ljava/util/List;
...
.method static synthetic a(Lhzt;Ljava/util/List;J)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lhzt;->b(Ljava/util/List;J)V
...
.method static synthetic b(Lhzt;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lhzt;->c:Landroid/content/Context;
...
.method private final b()Ljava/util/List;
    ...
    invoke-direct {v0, v2, v3}, Lhzx;-><init>(Ljava/lang/String;[B)V
...
.method private final declared-synchronized b(Ljava/util/List;J)V
    ...
    invoke-direct {p0, v2, v3}, Lhzt;->a(J)V
    ...
    invoke-direct {p0, v0}, Lhzt;->a(I)Ljava/util/List;
    ...
    invoke-direct {p0, p1, v0, v1}, Lhzt;->c(Ljava/util/List;J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {p0, v1}, Lhzt;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method private final c()I
    ...
    invoke-direct {p0, v2}, Lhzt;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method private final c(Ljava/util/List;J)V
    ...
    iget-object v5, v0, Lhzx;->a:Ljava/lang/String;
...
.method private final d()V
    ...
    invoke-virtual {v0}, Lhzw;->close()V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final a(Lhxz;)V
    ...
    iget-object v0, p0, Lhzt;->b:Ljava/util/concurrent/Executor;

    new-instance v1, Lhzv;

    invoke-direct {v1, p0, p1}, Lhzv;-><init>(Lhzt;Lhxz;)V
...
.method public final a(Ljava/util/List;J)V
    ...
    invoke-static {v0}, Lhzt;->a(Ljava/lang/Object;)[B

    move-result-object v0

    invoke-direct {v3, v4, v0}, Lhzx;-><init>(Ljava/lang/String;[B)V
    ...
    invoke-direct {v2, p0, v1, p2, p3}, Lhzu;-><init>(Lhzt;Ljava/util/List;J)V
