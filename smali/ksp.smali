...
# direct methods
.method public constructor <init>(Lktl;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Lksi;-><init>(Lktl;)V

    iput-object v0, p0, Lksp;->a:Lksi;
    ...
    iput-object v0, p0, Lksp;->b:Landroid/net/Uri;
    ...
    .line 48
    iput-object p4, p0, Lksp;->d:Ljava/lang/String;

    .line 49
    return-void
.end method

.method private static a(Lorg/apache/http/HttpResponse;)Lvoz;
    .locals 3
...
.method private static b(Lorg/apache/http/HttpResponse;)Lvoy;
    .locals 3
...
# virtual methods
.method public final a(Llcv;)Landroid/net/Uri;
    .locals 8
    ...
    .line 1135
    iget-object v1, p0, Lksp;->b:Landroid/net/Uri;
    ...
    iget-object v3, p0, Lksp;->c:Ljava/lang/String;
    ...
    invoke-virtual {v2, v1}, Lktv;->a(Landroid/net/Uri;)Lorg/apache/http/client/methods/HttpUriRequest;
    ...
    invoke-static {v2, v1}, Lksp;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;)V

    .line 61
    :goto_0
    invoke-virtual {p1}, Llcv;->b()J
    ...
    .line 63
    :try_start_0
    iget-object v1, p0, Lksp;->a:Lksi;

    invoke-virtual {v1, v2}, Lksi;->a(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;

    move-result-object v1

    .line 64
    invoke-static {v1}, Lksp;->a(Lorg/apache/http/HttpResponse;)Lvoz;

    move-result-object v1

    .line 65
    iget-object v1, v1, Lvoz;->a:[Ljava/lang/String;
    ...
    .line 2078
    :cond_1
    iget-object v1, p1, Llcv;->a:Llcx;

    .line 2135
    iget-wide v2, v1, Llcx;->c:J
...
.method public final a(Lksj;Llcv;)Lksv;
    .locals 8
    ...
    .line 2147
    iget-object v0, p0, Lksp;->b:Landroid/net/Uri;
    ...
    .line 3021
    iget-object v2, p1, Lksj;->a:Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lktv;->a(Landroid/net/Uri;)Lorg/apache/http/client/methods/HttpUriRequest;
    ...
    invoke-static {v2, v0}, Lksp;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;)V

    .line 106
    :goto_1
    invoke-virtual {p2}, Llcv;->b()J
    ...
    invoke-virtual {v0, v2}, Lksi;->a(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;
    :try_end_0
    .catch Lorg/apache/http/client/HttpResponseException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 129
    :cond_4
    invoke-static {v0}, Lksp;->b(Lorg/apache/http/HttpResponse;)Lvoy;
    ...
    iget-object v2, v1, Lvoy;->a:[Lvow;

    iget-wide v4, v1, Lvoy;->b:J

    invoke-direct {v0, p1, v2, v4, v5}, Lksv;-><init>(Lksj;[Lvow;J)V
