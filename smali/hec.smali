...
# direct methods
.method constructor <init>(Lgug;Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;)V
    .locals 0

    iput-object p2, p0, Lhec;->a:Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;

    invoke-direct {p0, p1}, Liac;-><init>(Lgug;)V
...
# virtual methods
.method protected final synthetic a(Lcom/google/android/gms/common/api/Status;)Lgup;
    .locals 2
    ...
    invoke-direct {v1, p1, v0}, Liaj;-><init>(Lcom/google/android/gms/common/api/Status;Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenResponse;)V
...
.method protected final synthetic a(Lgud;)V
    ...
    .line 1000
    iget-object v1, p0, Lhec;->a:Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;

    .line 2000
    new-instance v2, Lhea;

    invoke-direct {v2, p0}, Lhea;-><init>(Lguw;)V

    .line 3000
    iget v0, p1, Lhdy;->b:I

    iget-object v3, p1, Lhdy;->a:Landroid/content/Context;

    invoke-virtual {v3}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v3

    iget-object v4, p1, Lhdy;->c:Ljava/lang/String;

    iget v5, p1, Lhdy;->d:I

    iget-boolean v6, p1, Lhdy;->e:Z
    ...
    .line 2000
    :try_start_0
    invoke-virtual {p1}, Lhdy;->l()Landroid/os/IInterface;

    move-result-object v0

    check-cast v0, Lhdo;

    invoke-interface {v0, v1, v7, v2}, Lhdo;->a(Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;Landroid/os/Bundle;Lhdu;)V
    :try_end_0
    ...
    invoke-virtual {v2, v1, v0, v3}, Lhea;->a(Lcom/google/android/gms/common/api/Status;Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenResponse;Landroid/os/Bundle;)V
