...
# direct methods
.method constructor <init>(Lktl;Lkpp;)V
    .locals 1
    ...
    iput-object v0, p0, Lkxz;->b:Lkpp;

    .line 62
    return-void
.end method

.method private static a(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Laus;)V
    .locals 2

    .prologue
    .line 180
    invoke-virtual {p1}, Laus;->q()[B
...
# virtual methods
.method public final a(Laus;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    .locals 6
    ...
    .line 74
    invoke-virtual {p1}, Laus;->b()Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Laus;->l()Ljava/lang/String;
    ...
    .line 83
    :goto_1
    invoke-static {v2, p2}, Lkxz;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V

    .line 84
    invoke-virtual {p1}, Laus;->i()Ljava/util/Map;

    move-result-object v3

    invoke-static {v2, v3}, Lkxz;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V
    ...
    invoke-interface {v3}, Lava;->ab_()I
    ...
    .line 2109
    sget-object v5, Lkya;->a:[I

    invoke-virtual {v3}, Lauu;->ordinal()I
    ...
    .line 93
    iget-object v3, p0, Lkxz;->b:Lkpp;

    invoke-virtual {v3, v1}, Lkpp;->d(Ljava/lang/Object;)V

    .line 3104
    :cond_0
    iget-object v1, p0, Lkxz;->a:Lktl;
    ...
    .line 97
    iget-object v2, p0, Lkxz;->b:Lkpp;

    invoke-virtual {v2, v0}, Lkpp;->d(Ljava/lang/Object;)V
    ...
    invoke-virtual {p1}, Laus;->p()Ljava/lang/String;
    ...
    .line 1151
    invoke-static {v2, p1}, Lkxz;->a(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Laus;)V
    ...
    invoke-direct {v2, v3}, Lavo;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v4}, Lavo;->addHeader(Ljava/lang/String;Ljava/lang/String;)V
