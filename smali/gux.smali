...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lgux;->aa:Landroid/os/Handler;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, Lgux;->X:Landroid/util/SparseArray;
...
.method static synthetic a(Lgux;Lcom/google/android/gms/common/ConnectionResult;)Lcom/google/android/gms/common/ConnectionResult;
    ...
    iput-object p1, p0, Lgux;->Z:Lcom/google/android/gms/common/ConnectionResult;

    return-object p1
.end method

.method public static a(Lfo;)Lgux;
    .locals 3
...
.method public static b(Lfo;)Lgux;
    .locals 4
    ...
    invoke-virtual {v2, v0, v3}, Lgk;->a(Lfj;Ljava/lang/String;)Lgk;

    move-result-object v2

    invoke-virtual {v2}, Lgk;->c()I

    invoke-virtual {v1}, Lfv;->b()Z
...
.method private final c(ILcom/google/android/gms/common/ConnectionResult;)V
    ...
    iget-object v0, p0, Lgux;->X:Landroid/util/SparseArray;
    ...
    .line 5000
    iget-object v1, p0, Lgux;->X:Landroid/util/SparseArray;
    ...
    iget-object v2, p0, Lgux;->X:Landroid/util/SparseArray;
    ...
    .line 6000
    iget-object v2, v1, Lguy;->b:Lgug;

    invoke-virtual {v2, v1}, Lgug;->b(Lguk;)V

    iget-object v1, v1, Lguy;->b:Lgug;

    invoke-virtual {v1}, Lgug;->e()V

    .line 0
    :cond_0
    iget-object v0, v0, Lguy;->c:Lguk;

    if-eqz v0, :cond_1

    invoke-interface {v0, p2}, Lguk;->a(Lcom/google/android/gms/common/ConnectionResult;)V

    :cond_1
    invoke-virtual {p0}, Lgux;->w()V
...
.method static synthetic d(Lgux;)Landroid/os/Handler;
    ...
    iget-object v0, p0, Lgux;->aa:Landroid/os/Handler;

    return-object v0
.end method

.method private static x()Lgux;
    .locals 2
...
.method public final a(IILandroid/content/Intent;)V
    ...
    :pswitch_0
    invoke-virtual {p0}, Lgux;->v()Lgtr;

    move-result-object v2

    invoke-virtual {p0}, Lgux;->f()Lfo;

    move-result-object v3

    invoke-virtual {v2, v3}, Lgtr;->a(Landroid/content/Context;)I
    ...
    iput-object v0, p0, Lgux;->Z:Lcom/google/android/gms/common/ConnectionResult;
    ...
    iget-object v1, p0, Lgux;->Z:Lcom/google/android/gms/common/ConnectionResult;
...
.method protected a(ILcom/google/android/gms/common/ConnectionResult;)V
    ...
    .line 8000
    invoke-static {v3}, Lgtv;->a(I)Ljava/lang/String;
...
.method public final a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .prologue
    .line 0
    invoke-super {p0, p1, p2, p3, p4}, Lfj;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2, p2, p3, p4}, Lgug;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public final b(Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, Lgux;->Z:Lcom/google/android/gms/common/ConnectionResult;
...
.method protected final w()V
    ...
    iput-object v2, p0, Lgux;->Z:Lcom/google/android/gms/common/ConnectionResult;

    iget-object v1, p0, Lgux;->c:Lgwh;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lgux;->c:Lgwh;

    invoke-virtual {v1}, Lgwh;->b()V

    iput-object v2, p0, Lgux;->c:Lgwh;
