...
# direct methods
.method public constructor <init>(Lcom/google/android/libraries/youtube/player/features/storyboard/ScrubbedPreviewView;Landroid/view/View;Lqts;)V
    .locals 1
    ...
    iput-object v0, p0, Lqtq;->a:Lcom/google/android/libraries/youtube/player/features/storyboard/ScrubbedPreviewView;
    ...
    iput-object v0, p0, Lqtq;->c:Landroid/view/View;
    ...
    iput-object v0, p0, Lqtq;->b:Lqts;

    .line 34
    const/4 v0, 0x1

    iput-boolean v0, p0, Lqtq;->d:Z

    .line 35
    return-void
.end method

.method private final a(Lqtx;)V
    .locals 2

    .prologue
    .line 143
    iget-boolean v0, p0, Lqtq;->e:Z

    if-eqz v0, :cond_3

    .line 144
    iget-object v0, p0, Lqtq;->a:Lcom/google/android/libraries/youtube/player/features/storyboard/ScrubbedPreviewView;
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/libraries/youtube/player/features/storyboard/StoryboardFrameView;->a(Lqtx;)V
...
.method public final a(IJ)V
    ...
    invoke-virtual {p0, v0}, Lqtq;->a(Z)V
    ...
    iget-object v4, p0, Lqtq;->c:Landroid/view/View;
    ...
    iget-object v5, p0, Lqtq;->c:Landroid/view/View;
    ...
    invoke-virtual {p0, v1, v5, v4, v2}, Lqtq;->a(Landroid/graphics/Point;Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Point;)V

    .line 1084
    iget-object v5, p0, Lqtq;->a:Lcom/google/android/libraries/youtube/player/features/storyboard/ScrubbedPreviewView;
    ...
    .line 1092
    iget-object v0, p0, Lqtq;->b:Lqts;

    invoke-virtual {v0, p2, p3}, Lqts;->a(J)Lqtx;

    move-result-object v0

    invoke-direct {p0, v0}, Lqtq;->a(Lqtx;)V
...
.method public final a()Z
    ...
    .prologue
    .line 100
    iget-boolean v0, p0, Lqtq;->d:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lqtq;->b:Lqts;

    invoke-virtual {v0}, Lqts;->a()Z
