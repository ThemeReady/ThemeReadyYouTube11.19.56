...
# instance fields
.field private g:Lpnu;


# direct methods
.method private constructor <init>(Lkqs;Ljava/security/Key;Lkqs;Lrcd;Llce;)V
    .locals 3

    .prologue
    .line 66
    invoke-direct {p0, p2, p3, p4}, Lrce;-><init>(Ljava/security/Key;Lkqs;Lrcd;)V

    .line 67
    new-instance v0, Lpnu;

    invoke-direct {v0, p2, p5, p1}, Lpnu;-><init>(Ljava/security/Key;Llce;Lkqs;)V

    iput-object v0, p0, Lpmi;->g:Lpnu;

    .line 1152
    iget-object v0, p0, Lrce;->c:Lorg/apache/http/protocol/HttpRequestHandlerRegistry;

    .line 68
    const-string v1, "/pudl"

    iget-object v2, p0, Lpmi;->g:Lpnu;
...
.method public static a(Lkqs;Ljava/security/Key;Lkqs;Lrcd;Llce;)Lpmi;
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Lpmi;-><init>(Lkqs;Ljava/security/Key;Lkqs;Lrcd;Llce;)V
    ...
    iput-object v1, v0, Lrce;->e:Ljava/net/ServerSocket;
    ...
    .line 1146
    iget-object v2, v0, Lrce;->e:Ljava/net/ServerSocket;
    ...
    iput-object v1, v0, Lrce;->f:Ljava/util/concurrent/ExecutorService;

    .line 1148
    iget-object v1, v0, Lrce;->f:Ljava/util/concurrent/ExecutorService;

    new-instance v2, Lrcf;

    invoke-direct {v2, v0}, Lrcf;-><init>(Lrce;)V
...
.method public final a(Ljava/lang/String;ILjava/lang/String;JJJ)Landroid/net/Uri;
    ...
    .line 1160
    iget-object v1, p0, Lrce;->e:Ljava/net/ServerSocket;
    ...
    .line 2156
    iget-object v1, p0, Lrce;->d:Lrcx;

    .line 90
    invoke-virtual {v1, v0}, Lrcx;->a(Landroid/net/Uri;)Landroid/net/Uri;
